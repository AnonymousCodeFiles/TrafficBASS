# s52_al_compare.py — AL strategy comparison with caching
import torch
import numpy as np
...
def main():
    ...
    try:
        ...
        if cached_state is not None:
            ...
            # If no cache found, perform normal initialization
        ...
        iteration = 0
        save_interval = 10  # Set save interval to every 10 iterations
